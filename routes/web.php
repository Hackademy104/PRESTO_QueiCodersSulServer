...
Route::get('/ricerca/annuncio', [PublicController::class, 'searchAnnouncements'])->name('searchAnnouncements');
...
Route::get('/diventa/revisore', [RevisorController::class, 'diventaRevisore'])->middleware('auth')->name('diventaRevisore');
